...
Begin VB.Form frmChess3Client 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ni-Star Enterprises - ChessMASTER Mark III: Client Mode - Niall Mooney"
   ClientHeight    =   7800
   ClientLeft      =   150
   ClientTop       =   840
   ClientWidth     =   10260
   Icon            =   "Chess3Client.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   520
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   15
      Left            =   2925
      Picture         =   "Chess3Client.frx":1195E
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   22
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   16
      Left            =   3285
      Picture         =   "Chess3Client.frx":134A0
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   21
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   21
      Left            =   1485
      Picture         =   "Chess3Client.frx":14FE2
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   20
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   22
      Left            =   1845
      Picture         =   "Chess3Client.frx":151AC
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   19
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   23
      Left            =   2205
      Picture         =   "Chess3Client.frx":15376
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   18
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   24
      Left            =   2565
      Picture         =   "Chess3Client.frx":15540
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   17
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   25
      Left            =   2925
      Picture         =   "Chess3Client.frx":1570A
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   16
   ...
   Begin VB.PictureBox picPiece 
      ...
      Index           =   26
      Left            =   3285
      Picture         =   "Chess3Client.frx":158D4
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   15
   ...
   Begin RichTextLib.RichTextBox RTMain 
      ...
      Appearance      =   0
      AutoVerbMenu    =   -1  'True
      TextRTF         =   $"Chess3Client.frx":15A9E
   ...
   Begin VB.PictureBox picCanvas 
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   11
         Left            =   360
         Picture         =   "Chess3Client.frx":15B1E
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   68
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   11
         Left            =   960
         Picture         =   "Chess3Client.frx":16360
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   67
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   10
         Left            =   360
         Picture         =   "Chess3Client.frx":1642A
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   66
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   10
         Left            =   960
         Picture         =   "Chess3Client.frx":16C6C
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   65
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   9
         Left            =   360
         Picture         =   "Chess3Client.frx":16D36
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   64
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   9
         Left            =   960
         Picture         =   "Chess3Client.frx":16FB8
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   63
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   8
         Left            =   960
         Picture         =   "Chess3Client.frx":17082
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   62
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   8
         Left            =   360
         Picture         =   "Chess3Client.frx":1714C
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   61
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   7
         Left            =   960
         Picture         =   "Chess3Client.frx":1798E
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   60
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   7
         Left            =   360
         Picture         =   "Chess3Client.frx":17A58
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   59
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   6
         Left            =   360
         Picture         =   "Chess3Client.frx":1829A
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   58
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   5
         Left            =   360
         Picture         =   "Chess3Client.frx":1851C
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   56
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   4
         Left            =   360
         Picture         =   "Chess3Client.frx":1879E
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   54
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   3
         Left            =   360
         Picture         =   "Chess3Client.frx":18A20
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   52
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   6
         Left            =   960
         Picture         =   "Chess3Client.frx":18CA2
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   57
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   5
         Left            =   960
         Picture         =   "Chess3Client.frx":18D6C
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   55
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   4
         Left            =   960
         Picture         =   "Chess3Client.frx":18E36
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   53
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   3
         Left            =   960
         Picture         =   "Chess3Client.frx":18F00
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   51
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   2
         Left            =   360
         Picture         =   "Chess3Client.frx":18FCA
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   50
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   2
         Left            =   960
         Picture         =   "Chess3Client.frx":1924C
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   49
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   1
         Left            =   960
         Picture         =   "Chess3Client.frx":19316
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   48
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   1
         Left            =   360
         Picture         =   "Chess3Client.frx":193E0
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   47
      ...
      Begin VB.PictureBox picMask 
         ...
         Index           =   0
         Left            =   960
         Picture         =   "Chess3Client.frx":19662
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   46
      ...
      Begin VB.PictureBox picIcon 
         ...
         Index           =   0
         Left            =   360
         Picture         =   "Chess3Client.frx":198E4
         ScaleHeight     =   32
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   32
         TabIndex        =   45
   ...
   Begin VB.PictureBox picEffector 
      ...
      Index           =   1
      Left            =   7440
      Picture         =   "Chess3Client.frx":19B66
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   14
   ...
   Begin VB.PictureBox picEffector 
      ...
      Index           =   0
      Left            =   7440
      Picture         =   "Chess3Client.frx":1A8A8
      ScaleHeight     =   48
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   48
      TabIndex        =   82
   ...
   Begin VB.Image Image1 
      Height          =   7800
      Left            =   0
      Picture         =   "Chess3Client.frx":1B523
      Stretch         =   -1  'True
      Top             =   0
      Width           =   10260
   End
   ...
   End
End
Attribute VB_Name = "frmChess3Client"
...
If Mode <> "Client" Then Exit Sub
WsClient.SendData "InstantMsg" + Chr$(27) + Trim$(txtUserName.Text) + "says: " + TxtSend.Text + vbNewLine
...
picCanvas.Cls
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Clear"
Call MarkNetworkActivity
End If
End Sub
...
If MsgBox("Do you wish to disconnect in disgrace?", vbQuestion + vbYesNo, "NSE ChessMASTER III") = vbYes Then WsClient.Close
End If

WsClient.Close
WsClient.Connect txtServerIP.Text
RTMain.Text = "-Connecting..." + vbNewLine + RTMain.Text

If Err Then MsgBox Err.Description, vbCritical, "NSE ChessMASTER Mark III"
End Sub
...
txtUserName.Text = WsClient.LocalHostName
End Sub
...
RTMain.Text = "-New GameState Aquired..." + vbNewLine + RTMain.Text
...
WsClient.SendData "MakeMove" + Chr$(27) + Trim$(Str$(Rank1)) + Chr$(27) + Trim$(Str$(File1)) + Chr$(27) + Trim$(Str$(Rank2)) + Chr$(27) + Trim$(Str$(File2))
Call MarkNetworkActivity
...
If Colour = "W" And Mode = "Client" Then
MoveAlright = False
Exit Function
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Line" + Chr$(27) + Trim$(Str$(StartX)) + Chr$(27) + Trim$(Str$(StartY)) + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY)) + Chr$(27) + Trim$(Str$(picCanvas.ForeColor))
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "BF" + Chr$(27) + Trim$(Str$(StartX)) + Chr$(27) + Trim$(Str$(StartY)) + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY)) + Chr$(27) + Trim$(Str$(picCanvas.ForeColor))
...
Shape1.Visible = False
If Button = vbLeftButton Then picCanvas.ForeColor = picColour1.BackColor Else picCanvas.ForeColor = picColour2.BackColor
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "BUF" + Chr$(27) + Trim$(Str$(StartX)) + Chr$(27) + Trim$(Str$(StartY)) + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY)) + Chr$(27) + Trim$(Str$(picCanvas.ForeColor))
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "EF" + Chr$(27) + Trim$(Str$(StartX)) + Chr$(27) + Trim$(Str$(StartY)) + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY)) + Chr$(27) + Trim$(Str$(picCanvas.ForeColor))
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "EUF" + Chr$(27) + Trim$(Str$(StartX)) + Chr$(27) + Trim$(Str$(StartY)) + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY)) + Chr$(27) + Trim$(Str$(picCanvas.ForeColor))
Ellipse picCanvas.hdc, StartX, StartY, EndX, EndY
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Light" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Banan" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Extat" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Pleas" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Okay" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "UHappy" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Crying" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Logo1" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Logo2" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "Nyer" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "UK" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If
...
If Mode = "Client" Then WsClient.SendData "PicMsg" + Chr$(27) + "US" + Chr$(27) + Trim$(Str$(EndX)) + Chr$(27) + Trim$(Str$(EndY))
End If

If Mode = "Client" Then Call MarkNetworkActivity
...
Status = Status + "Connect to a Server To Play" + vbNewLine
End Select

Select Case Turn
Case 0
If Mode = "Client" Then Status = Status + "Your Turn, " + txtUserName.Text
Case 1
If Mode = "Client" Then Status = Status + "Waiting for " + RemoteUN.Caption
End Select
...
If Rules = False Then Status = Status + vbNewLine + "~No Move Law~": picFrontBuffer.ToolTipText = "[Legal] " + picFrontBuffer.ToolTipText
Else
...
If Mode = "Client" Then WsClient.SendData "ID" + Chr$(27) + Username
Call MarkNetworkActivity
End Sub

Private Sub WsClient_Close()
RTMain.Text = "-Networking Critical Error. The Server is Disconnected" + vbNewLine + RTMain.Text
MsgBox "Networking Critical Error. We have been disconnected or the server has choosen to 'disconnect in disgrace'. Your glory is intact.", vbExclamation + vbOKOnly
Mode = ""
End Sub

Private Sub WsClient_Connect()
RTMain.Text = "-Connected to " + WsClient.RemoteHost + "..." + vbNewLine + RTMain.Text
Mode = "Client"
WsClient.SendData "ID" + Chr$(27) + Username
Rules = True
Beep
Command3.Caption = "Disconnect"
RTMain.Text = "-ID sent to Server, Awaiting Gamestate..." + WsClient.RemoteHost + vbNewLine + RTMain.Text
Call MarkNetworkActivity
End Sub
...
lblServerIP.Caption = WsClient.RemoteHostIP
End If
...
If Segment(0) = "InitiateNewGame" Then InitiateNewGame
Call MarkNetworkActivity
End Sub
...
If WsClient.State <> sckConnected Then RTMain.Text = "Networking Critical Error." + vbNewLine + RTMain.Text: MsgBox Description, vbCritical Else RTMain.Text = "Networking Error" + vbNewLine + RTMain.Text
WsClient.Close
End Sub
